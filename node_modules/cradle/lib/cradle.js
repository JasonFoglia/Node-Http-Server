...
remove: function (id, rev) {
        ...
        this.query('DELETE', cradle.escape(id), {
                rev: rev
        }, function (err, res) {
                if (! err) {
                        that.cache.purge(id)
...
saveAttachment: function (/* id, [rev], attachmentName, contentType, dataOrStream */) {
        ...
        if (typeof(args.first) === 'object') {
                throw new(TypeError)("first argument must be a document id")
        }
